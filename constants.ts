...
export const downloadFolder = RNFS.DownloadDirectoryPath + '/braveflix';
...
export const socialLinks = {
  github: 'https://github.com/braveflix/braveflix-app',
  discord: 'https://discord.gg/cr42m6maWy',
  sponsor: 'https://github.com/sponsors/braveflix',
};
